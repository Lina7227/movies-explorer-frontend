            ...
            <div className="about-me__block">
                <div className="about-me__block-info">
                    ...
                    <nav className="about-me__contacts">
                        <a href="https://www.linkedin.com/in/linakricosheina7227/" target="_blank" className="about-me__link">
                            <p className="about-me__link-text">Linkidin</p>
                        </a>
                        <a href="https://github.com/Lina7227" target="_blank" className="about-me__link">
