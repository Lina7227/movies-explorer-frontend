            ...
            <div className="about-me__block">
                <div className="about-me__block-info">
                    ...
                    <article className="about-me__info">
                        По образованию историк. С февраля 2021 года начала интресоваться сферой IT, в частность frontend-разработкой. Начала работать верстальщиком с начала обучения. Увлекаюсь путешествиями, спортом, книгами и музыкой. В дальнейшем хочу заниматься frontend-разработкой в интересных и полезных проектах.
                    </article>
